...
CREATE TABLE MEMBER_TBL_11 (
    ...
    tel VARCHAR2(20) NOT NULL,  -- 전화번호 (예: 02)123-4567
    deptno VARCHAR2(10) NOT NULL
);

INSERT INTO MEMBER_TBL_11 (member_id, member_name, tel, deptno) VALUES
('M001', '김철수', '02)123-4567', '101');
INSERT INTO MEMBER_TBL_11 (member_id, member_name, tel, deptno) VALUES ('M002', '이영희', '051)987-6543', '102');
INSERT INTO MEMBER_TBL_11 (member_id, member_name, tel, deptno) VALUES ('M003', '박민수', '033)555-8888', '101');
INSERT INTO MEMBER_TBL_11 (member_id, member_name, tel, deptno) VALUES ('M004', '최다혜', '052)777-9999', '103');
INSERT INTO MEMBER_TBL_11 (member_id, member_name, tel, deptno) VALUES ('M005', '정우진', '055)111-2222', '101');
...
INSERT INTO CUST_INFO VALUES ('8301111567897' , 'JHUN' , 'KIM', 330.08);
 ...
 CREATE TABLE MEMBER_TBL_11 
(
  M_ID VARCHAR2(5 BYTE) NOT NULL 
, M_PW VARCHAR2(5 BYTE) 
, M_NAME VARCHAR2(10 BYTE) 
, M_TEL VARCHAR2(13 BYTE) 
, M_BIRTHDAY DATE 
, M_POINT NUMBER(6, 0) 
, M_GRADE VARCHAR2(2 BYTE) 
, CONSTRAINT SYS_C007496 PRIMARY KEY
);